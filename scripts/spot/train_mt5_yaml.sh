...
DATASET_VERSION=v10
MODEL_VERSION=v1
MODEL_OUT=model/mt5_tuned_base_minimized_${MODEL_VERSION}_db-${DATASET_VERSION}_yaml_out
MAX_LENGTH=1024
EVAL_METRIC=eval_rouge2
RESULT_FILE_PATH=results/mt5_tuned_base_minimized_${MODEL_VERSION}_db-${DATASET_VERSION}_output_yaml_out.tsv
...
TEST_DATASET=tasks/spot/${DATASET_VERSION}/IMR_Dataset_${DATASET_VERSION}_test_ChatNL_minimized_yaml_out.csv
